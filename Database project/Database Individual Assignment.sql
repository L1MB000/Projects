...
ISBN int Primary Key, book_title char(50), book_price float, book_quantity int,
...
ISBN int Foreign Key references TotalBook(ISBN), book_review varchar(50), book_rating float
);

CREATE TABLE OrderDetail(
OrderID varchar(50) Primary Key, order_date date, shipmentID varchar(50) Foreign Key references Shipment(ShipmentID),
ISBN int Foreign Key references TotalBook(ISBN)
);
...
('00001', 'Contrarella', '70', '6', 'AID00001', 'PID00001', 'WHS00001'), ('00002', 'kanata no astra', '40', '12','AID00002', 'PID00002', 'WHS00002'), 
('00003', 'County n country', '25', '5', 'AID00003', 'PID00003', 'WHS00003'),('00004', 'das kommandier', '15', '3', 'AID00004', 'PID00004', 'WHS00004'), 
('00005', 'art of peace', '20', '9', 'AID00005', 'PID00005', 'WHS00005');

INSERT INTO CustomerReview(ReviewID, CustomerID, ISBN, book_review, book_rating)VALUES
('RNR00001', 'CUS00001', '00001', 'it worth the time reading it', '7'), ('RNR00002', 'CUS00002', '00002', 'The book waste my time', '3'),
('RNR00003', 'CUS00003', '00003', 'It is not worth it', '2'), ('RNR00004', 'CUS00004', '00004', 'Good plot by the author', '8'),
('RNR00005', 'CUS00005', '00005', 'THIS BOOK IS A MASTERPIECE!!! ', '10'), ('RNR00006', 'CUS00005', '00005', 'the ending could have been better ', '7'),
('RNR00007', 'CUS00005', '00005', 'it really missing something', '5');

INSERT INTO OrderDetail(OrderID, order_date, shipmentID, ISBN)VALUES
('ORD00001', '2022-03-12', 'SID00001', '00001'), ('ORD00002', '2022-03-15', 'SID00002', '00002'), 
('ORD00003', '2022-05-04', 'SID00003', '00003'), ('ORD00004', '2022-06-1', 'SID00004', '00004'), 
('ORD00005', '2022-06-15', 'SID00005', '00005'), ('ORD00006', '2022-06-16', 'SID00006', '00005'),
('ORD00007', '2022-06-18', 'SID00007', '00005');
